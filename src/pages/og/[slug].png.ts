...
export const GET: APIRoute = async ({ props }) => {
  ...
  // Articles with a hero image: just crop to 1200×630, no overlay.
  // The platform (X, LinkedIn) already shows the title from meta tags.
  if (heroImage) {
  ...
  // Articles without an image: generate a title card
            ...
            props: {
              ...
              children: [
                ...
                },
                {
                  type: "div",
                  props: {
                    style: { color: "#878580", fontSize: "22px", fontWeight: "400" },
